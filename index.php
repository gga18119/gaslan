<html>
        <head>
                <title>Grupo Aslan</title>
        </head>
        <body>
                <h1> Grupo Aslan</h1>
                <h2> Tus aliados en la producción de ese evento</h2>
                <h3> Conoce nuestros servicios </h3>
                <p>Servicio profesional en la producción de algodones de azúcar, <br>
                        contamos con puntos de venta al menudeo además atendemos pedidos especiales desde 30 piezas, <br>
                        ...
                        Amarillo- Piña.       <br>
                        Morado-   Uva.    <br>
                        Rosa-Cereza/Chicle <br>
                        Blanco- Coco     <br>

                        <center>Etiquetas impresas personalizadas + $1 por pieza </center>
                </p>
